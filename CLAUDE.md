...
**nopkg** is a CLI tool built with [oclif](https://oclif.io) to protect supply chain security. This is an ES module project (type: "module" in package.json) using TypeScript with Node16 module resolution.
